...
function App() {
  ...
  return (
    <div className="page">
      ...
      <ModalWithForm isOpen={isEditProfileModalOpen} onClose={handleCloseAllModals} title={"Edit profile"} name="edit" />
      <ModalWithForm isOpen={isAddPlaceModalOpen} onClose={handleCloseAllModals} title={"New place"} name="add" />
      <ModalWithForm isOpen={isEditAvatarModalOpen} onClose={handleCloseAllModals} title={"Change profile picture"} name="avatar-edit" />

      <ModalWithImage card={selectedCard} onClose={handleCloseAllModals} />
